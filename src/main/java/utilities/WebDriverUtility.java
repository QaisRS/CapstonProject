...
public class WebDriverUtility extends Base {
    ...
    public static void takeScreenShot() { // this code has few thing 1. location.
    	//we need to provide the extension .png, and location and screenshot name must match with path.
